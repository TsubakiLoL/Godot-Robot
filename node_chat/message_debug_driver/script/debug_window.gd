...
const DEBUG_WINDOW_SIDE_BTN = preload("res://node_chat/message_debug_driver/tscn/debug_window_side_btn.tscn")
...
const DEBUG_GRAPH = preload("res://node_chat/message_debug_driver/tscn/debug_graph.tscn")

...
const SELECT_NODESET = preload("res://node_chat/welcome/tscn/select_nodeset.tscn")
...
func _on_download_data_pressed() -> void:
	var window=preload("res://node_chat/welcome/tscn/download_from_server.tscn").instantiate()
